...
Por ejemplo, con una limpieza selectiva por columnas. En el siguiente ejemplo haríamos una extracción selecitva de todos las filas donde no hay $NAs$ dentro de la columna "Income" y nos quedaríamos con todas las columnas. Toda esta extracción la guardamos en una nueva variable que se llamará data.income.cleaned (**COMPARAR ESTA VARIABLE CON LA PROPIA DATA QUE ES LA ORIGINAL**).
